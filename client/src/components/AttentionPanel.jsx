    ...
    <section className="panel p-6">
      ...
      {featuredReel ? (
        ...
        >
          ...
          <p className="mt-3 font-display text-3xl text-white">{featuredReel.performanceScore ?? 0}<span className="text-lg text-slate-400">/100</span></p>
          ...
          secondaryReels.map((reel) => (
            ...
            >
              ...
              <div className="shrink-0 text-right">
                <p className="font-display text-2xl text-white">{reel.performanceScore ?? 0}<span className="text-sm text-slate-400">/100</span></p>
                <p className="mt-1 text-xs uppercase tracking-[0.16em] text-slate-500">Score</p>
              </div>
            </button>
          ))
        ) : (
